...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="number" id="klantID" name="klantID"><br><br>
        
        <label for="tafelID">Tafel ID:</label><br>
        <input type="number" id="tafelID" name="tafelID"><br><br>
        ...
        <input type="number" id="aantalPersonen" name="aantalPersonen"><br><br>
